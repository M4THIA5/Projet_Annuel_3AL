...
function Spinner() {
    ...
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
             className={"animate-spin fill-white hidden"} id="spinner">
            <path
...
export function RegisterForm({
    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Alert variant="destructive" id={"error-alert"} className={"hidden"}>
            ...
            <CardContent>
                <Form action={""} formMethod={"POST"} onSubmit={event => handleSubmit(event)}>
